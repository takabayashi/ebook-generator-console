...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { book_id: @widget.book_id, full_path: @widget.full_path, title: @widget.title }
    end
  ...
  test "should update widget" do
    patch :update, id: @widget, widget: { book_id: @widget.book_id, full_path: @widget.full_path, title: @widget.title }
    assert_redirected_to widget_path(assigns(:widget))
  end
